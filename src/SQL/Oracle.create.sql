...
ALTER TABLE "ФормаРегКарт"
	ADD CONSTRAINT "ФормаРегКарт__3378" FOREIGN KEY ("КартыДоступа") REFERENCES "КартыДоступа" ("primaryKey");

CREATE INDEX "ФормаРегКарт__1589" on "ФормаРегКарт" ("КартыДоступа");
...
ALTER TABLE "ТчРегВхода"
	ADD CONSTRAINT "ТчРегВхода_FГ_8828" FOREIGN KEY ("Гость") REFERENCES "Гость" ("primaryKey");

CREATE INDEX "ТчРегВхода_IГ_8907" on "ТчРегВхода" ("Гость");

ALTER TABLE "ТчРегВхода"
	ADD CONSTRAINT "ТчРегВхода_FС_2074" FOREIGN KEY ("Сотрудник") REFERENCES "Сотрудник" ("primaryKey");

CREATE INDEX "ТчРегВхода_IС_2014" on "ТчРегВхода" ("Сотрудник");

ALTER TABLE "ТчРегВхода"
	ADD CONSTRAINT "ТчРегВхода_FК_6503" FOREIGN KEY ("КартыДоступа") REFERENCES "КартыДоступа" ("primaryKey");

CREATE INDEX "ТчРегВхода_IК_7328" on "ТчРегВхода" ("КартыДоступа");

ALTER TABLE "ТчРегВхода"
	ADD CONSTRAINT "ТчРегВхода_FД_9454" FOREIGN KEY ("Должности") REFERENCES "Должности" ("primaryKey");

CREATE INDEX "ТчРегВхода_IД_9531" on "ТчРегВхода" ("Должности");

ALTER TABLE "ТчРегВхода"
	ADD CONSTRAINT "ТчРегВхода_FФ_5566" FOREIGN KEY ("ФормаРегВхода") REFERENCES "ФормаРегВхода" ("primaryKey");

CREATE INDEX "ТчРегВхода_IФ_6679" on "ТчРегВхода" ("ФормаРегВхода");
