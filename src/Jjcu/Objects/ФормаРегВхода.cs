...
namespace IIS.Jjcu
{
    ...
    [View("ФормаРегВходаE", new string[] {
            ...
            "Комната.Номер"})]
    [AssociatedDetailViewAttribute("ФормаРегВходаE", "ТчРегВхода", "ТчРегВходаE", true, "", "Тч рег входа", true, new string[] {
            ""})]
    ...
    public class ФормаРегВхода : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Jjcu.DetailArrayOfТчРегВхода fТчРегВхода;
        ...
        public virtual IIS.Jjcu.DetailArrayOfТчРегВхода ТчРегВхода
        {
            get
            {
                ...
                {
                    this.fТчРегВхода = new IIS.Jjcu.DetailArrayOfТчРегВхода(this);
                }
                IIS.Jjcu.DetailArrayOfТчРегВхода result = this.fТчРегВхода;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормаРегВходаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормаРегВходаE", typeof(IIS.Jjcu.ФормаРегВхода));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормаРегВходаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормаРегВходаL", typeof(IIS.Jjcu.ФормаРегВхода));
                }
            }
        }
    }
