...
namespace IIS.Jjcu
{
    ...
    [View("КомнатаE", new string[] {
            "Номер as \'Номер\'",
            "Этаж as \'Этаж\'",
            "КолвоКроватей as \'Колво кроватей\'"})]
    ...
    public class Комната : ICSSoft.STORMNET.DataObject
    {
        ...
        /// КолвоКроватей.
        /// </summary>
        // *** Start programmer edit section *** (Комната.КолвоКроватей CustomAttributes)

        // *** End programmer edit section *** (Комната.КолвоКроватей CustomAttributes)
        public virtual int КолвоКроватей
        {
            get
            {
                // *** Start programmer edit section *** (Комната.КолвоКроватей Get start)

                // *** End programmer edit section *** (Комната.КолвоКроватей Get start)
                int result = this.fКолвоКроватей;
                // *** Start programmer edit section *** (Комната.КолвоКроватей Get end)

                // *** End programmer edit section *** (Комната.КолвоКроватей Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Комната.КолвоКроватей Set start)

                // *** End programmer edit section *** (Комната.КолвоКроватей Set start)
                this.fКолвоКроватей = value;
                // *** Start programmer edit section *** (Комната.КолвоКроватей Set end)

                // *** End programmer edit section *** (Комната.КолвоКроватей Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КомнатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаE", typeof(IIS.Jjcu.Комната));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КомнатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаL", typeof(IIS.Jjcu.Комната));
                }
            }
        }
    }
